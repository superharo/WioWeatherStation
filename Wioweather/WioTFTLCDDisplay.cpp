...
void LCD_Init(uint16_t background_color)
{
    ...
    tft_lcd.init();         // Initialize screen
    tft_lcd.setRotation(1); // Set screen orientation
    tft_lcd.fillScreen(background_color);
    ...
    tft_lcd.drawString("By haro", 160, 190);
}
...
bool CurrentDisplay(OW_current *current)
{
    ...
    {
    case 1:
        level_color = TFT_GREEN;
        break;
    case 2:
        level_color = TFT_YELLOW;
        break;
    case 3:
        level_color = TFT_ORANGE;
        break;
    case 4:
        level_color = TFT_RED;
        break;
    case 5:
        level_color = TFT_PURPLE;
        break;
    default:
        level_color = TFT_MAROON;
        break;
    }
...
bool ForecastDisplay(OW_forecast *forecast)
{
    ...
    {
    case 1:
        level_color[0] = TFT_GREEN;
        break;
    case 2:
        level_color[0] = TFT_YELLOW;
        break;
    case 3:
        level_color[0] = TFT_ORANGE;
        break;
    case 4:
        level_color[0] = TFT_RED;
        break;
    case 5:
        level_color[0] = TFT_PURPLE;
        break;
    default:
        level_color[0] = TFT_MAROON;
        break;
    }
    ...
    {
    case 1:
        level_color[1] = TFT_GREEN;
        break;
    case 2:
        level_color[1] = TFT_YELLOW;
        break;
    case 3:
        level_color[1] = TFT_ORANGE;
        break;
    case 4:
        level_color[1] = TFT_RED;
        break;
    case 5:
        level_color[1] = TFT_PURPLE;
        break;
    default:
        level_color[1] = TFT_MAROON;
        break;
    }
    ...
    {
    case 1:
        level_color[2] = TFT_GREEN;
        break;
    case 2:
        level_color[2] = TFT_YELLOW;
        break;
    case 3:
        level_color[2] = TFT_ORANGE;
        break;
    case 4:
        level_color[2] = TFT_RED;
        break;
    case 5:
        level_color[2] = TFT_PURPLE;
        break;
    default:
        level_color[2] = TFT_MAROON;
        break;
    }
