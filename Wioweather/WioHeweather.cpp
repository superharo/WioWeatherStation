...
void OW_Weather::printCurrentWeather()
{
	...
	Serial.println(this->current->wea_updateTime);
	Serial.print("Text             : ");
	Serial.println(this->current->text);
	Serial.print("Temp             : ");
	Serial.println(this->current->temp);
	Serial.print("Humidity         : ");
	Serial.println(this->current->humidity);
	Serial.print("WindScale        : ");
	Serial.println(this->current->windscale);
	Serial.print("Icon             : ");
	Serial.println(this->current->icon);
	Serial.println("############ Current Air Pollution ############");
	Serial.print("Update Time      : ");
	Serial.println(this->current->pol_updateTime);
	Serial.print("Level            : ");
	Serial.println(this->current->level);
	Serial.print("Category         : ");
	Serial.println(this->current->category);
	Serial.print("PM2.5            : ");
	Serial.println(this->current->pm2p5);
	Serial.print("PM10             : ");
	Serial.println(this->current->pm10);
	Serial.println();
}
...
void OW_Weather::printForecastWeather()
{
	...
	Serial.print("Update Time      : ");
	Serial.println(this->forecast->wea_updateTime);
	for (i = 0; i < FORECAST_DAYS; i++)
	{
		Serial.print("Forecast Date    : ");
		Serial.println(this->forecast->fxDate[i]);
		Serial.print("Text             : ");
		Serial.println(this->forecast->textDay[i]);
		Serial.print("TempMax          : ");
		Serial.println(this->forecast->tempMax[i]);
		Serial.print("TempMin          : ");
		Serial.println(this->forecast->tempMin[i]);
		Serial.print("WindScale        : ");
		Serial.println(this->forecast->windscale[i]);
		Serial.print("Humidity         : ");
		Serial.println(this->forecast->humidity[i]);
		Serial.print("Icon             : ");
		Serial.println(this->forecast->iconDay[i]);
		Serial.println();
	}
	Serial.println("############ Forecast Air Pollution ############");
	Serial.print("Update Time      : ");
	Serial.println(this->forecast->pol_updateTime);
	for (i = 0; i < FORECAST_DAYS; i++)
	{
		Serial.print("AQI              : ");
		Serial.println(this->forecast->aqi[i]);
		Serial.print("Level            : ");
		Serial.println(this->forecast->level[i]);
		Serial.print("Category         : ");
		Serial.println(this->forecast->category[i]);
		Serial.println();
	}
}
